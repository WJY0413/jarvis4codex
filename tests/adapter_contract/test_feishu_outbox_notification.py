    ...
    def test_notification_requires_exact_delivered_readback(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            config = FeishuOutboxNotificationConfig(
                ...
                bridge_script=Path("bridge.py"), bridge_config=Path("bridge.json"),
            ...
            def runner(command, **_kwargs):
                ...
                return subprocess.CompletedProcess(command, 0, json.dumps({"ok": True, "delivered_count": 1}), "")
        ...
        self.assertIn("--send-outbox-id", calls[1])
